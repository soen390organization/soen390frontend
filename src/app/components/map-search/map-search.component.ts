...
export class MapSearchComponent {
  ...
  onSearchChangeStart(event: any) {
    this.onSearch(event, 'https://upload.wikimedia.org/wikipedia/commons/8/8e/Icone_Verde.svg');
  }

  onSearchChangeDestination(event: any) {
    this.onSearch(event, 'https://upload.wikimedia.org/wikipedia/commons/6/64/Icone_Vermelho.svg');
  }
